...
//do
//        {
//        if (return_val=select(getdtablesize(), &ready1, (fd_set *)NULL, (fd_set *)NULL, &timeout1)>0)
//        if ( alim[supply_number].mode ) fgetc( alim[supply_number].rs232r ) ;
//        ddd++;
//        } while (alim[supply_number].mode );
...
//printf("rs=*%d %d %d %d %d %d %d %d %d %d %d %d %d*\n",
//return_string[0],
//return_string[1],
//return_string[2],
//return_string[3],
...
//return_string[12]);
	    ...
	    if (return_string[4] == 13) corrente = 0;
            if ( verbose ) printf( "%s: corrente letta = %f     first echo + answer is ^^^%s$$$\n",
...
//            FD_CLR(alim[supply_number].fildes, &ready);
	    ...
	    if (return_string[4] == '-') correnteimpostata = correnteimpostata * -1.0;
            ...
            if ( verbose ) printf( "%s: corrente impostata = %f     first echo + answer is ^^^%s$$$\n",
...
/****************************************************************************************************************************************************/
        ...
        /*fprintf (alim[supply_number].rs232w ,"CUR/\r");*/
        fprintf (alim[supply_number].rs232w ,"C");
        fflush (alim[supply_number].rs232w);
        fprintf (alim[supply_number].rs232w ,"U");
        fflush (alim[supply_number].rs232w);
