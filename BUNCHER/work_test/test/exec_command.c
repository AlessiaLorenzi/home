...
char device_msg1[100];
   ...
   do {
	if ( alarm_flag )
	    ...
	    not_echo_flag = FALSE ;
        //printf( "\n%s: stringa : %s\n", myname, device_msg ) ;
    	printf("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF (exec do read) command is %s \n",client_msg);
...
int *motcntr_mode, *flag_pointer ;
{
    ...
    printf("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF (exec start) command is %s \n",client_msg);
        ...
        *motcntr_mode = TRUE ;
	    ...
	    siginterrupt(SIGALRM, 1);
		 ...
		 //printf( "MOTOR SERVER: last string was %s\n", device_msg ) ;
    		 printf("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF (exec) command is %s \n",client_msg);
    		 printf("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF (exec) answer is %s \n",device_msg);
	        }
            else 
	        {
